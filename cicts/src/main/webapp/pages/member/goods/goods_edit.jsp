...
<head>
    ...
    <script type="text/javascript" src="/statics/js/admin/goods/goods_edit.js"></script>
</head>
<body>
            ...
            <div class="member_cort">
                ...
                <div class="member_cort-right fr">
                    ...
                    <div class="panel-body" style="height: 80%;">
                        <form action="goods/edit" method="post" class="form-horizontal" id="goodsForm" enctype="multipart/form-data">
                            <fieldset>
                                <div class="form-group" id="nameDiv">
                                    <label class="col-md-2 control-label" for="name">商品名称：</label>
                                    <div class="col-md-5">
                                        <input type="text" id="name" name="gname" class="form-control" placeholder="请填写商品名称" value="${goods.gname}">
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        <select id="item" name="type.tid" class="form-control">
                                            ...
                                            <c:forEach var="types" items="${types}">
                                                <option value="${types.tid}" ${types.tid==goods.gid? "checked":""}>${types.tname}</option>
                                            </c:forEach>
                                ...
                                <div class="form-group" id="photoDiv">
                                    ...
                                    <div class="col-md-5">
                                        <img src="upload/${goods.gimg}" style="width: 50px;">
                                ...
                                <div class="form-group" id="noteDiv">
                                    ...
                                    <div class="col-md-5">
                                        <textarea id="note" name="desc" class="form-control" placeholder="请输入关于该商品的信息描述">${goods.desc}</textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-3 col-md-offset-3">
                                        ...
                                        <input type="hidden" name="pic" value="${goods.gimg}">
